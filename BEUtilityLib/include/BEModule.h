...
namespace BlackEngine
{
	...
	public:
		static T& Instance()
		{
			if (IsShutDown())
			{
				//std::exception(InternalErrorException, "Trying to access a module but it hasn't been started up yet.");
			}
		...
		static void StartUp(Args&&... args)
		{
			if (!IsShutDown())
			{
				//std::exception(InternalErrorException, "Trying to start an already started module.");
			}
		...
		static void ShutDown()
		{
			...
			{
				//std::exception(/*InternalErrorException*/, "Trying to shut down an already shut down module.");
			}
